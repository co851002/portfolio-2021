<template>
  <footer class="footer flex flex-wrap ">
    <div
      class=" flex mx-auto px-6 flex-wrap flex-row items-center justify-center w-screen"
    >
      <a
        rel="noopener"
        href="https://github.com/co851002"
        target="_blank"
        aria-label="Github"
        class="footer-link px-2 fill-current"
        ><svg
          aria-hidden="true"
          width="23.25"
          height="24"
      ...
      <a
        rel="noopener"
        href="https://codepen.io/co851002"
        target="_blank"
        aria-label="Codepen"
      ...
      <a
        rel="noopener"
        href="https://twitter.com/co851002"
        target="_blank"
        aria-label="Twitter"
        class="footer-link px-2"
        ><svg
      ...
      <a
        rel="noopener"
        href="https://medium.com/@co851002"
        target="_blank"
        aria-label="Medium"
        class="footer-link px-2"
        ><svg
